      ...
      <div className="p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-gray-900 mb-1">{route.name}</h1>
          ...
          <div className="flex items-center gap-3">
            <span
              className={`px-4 py-2 rounded-full text-white ${
                route.active ? 'bg-[#10B981]' : 'bg-gray-500'
              }`}
            >
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-900 text-2xl">{route.distanceKm} km</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-900 text-2xl">₫{(route.basePrice || 0) / 1000}K</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-900 text-2xl">{route.stops.length + 2}</p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-md mb-6">
                ...
                <div>
                  ...
                  {isEditingRoute ? (
                    <select
                      ...
                      onChange={(e) =>
                        setRouteFormData({ ...routeFormData, operatorId: e.target.value })
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2563EB] text-gray-900"
                    >
                      {operators.map((op) => (
                ...
                <div>
                  ...
                  {isEditingRoute ? (
                    <select
                      ...
                      onChange={(e) =>
                        setRouteFormData({ ...routeFormData, originStopId: e.target.value })
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2563EB] text-gray-900"
                    >
                ...
                <div>
                  ...
                  {isEditingRoute ? (
                    <select
                      ...
                      onChange={(e) =>
                        setRouteFormData({ ...routeFormData, destinationStopId: e.target.value })
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2563EB] text-gray-900"
                    >
                      {availableStops.map((stop) => (
                ...
                <div>
                  ...
                  {isEditingRoute ? (
                    <select
                      ...
                      onChange={(e) =>
                        setRouteFormData({ ...routeFormData, active: e.target.value === 'active' })
                      }
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2563EB] text-gray-900"
                    >
                    ...
                    <div className="flex-1 bg-white border-2 border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
                      ...
                      <div className="flex items-center gap-6 mt-3">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="text-gray-600">
                            {Math.floor((stop.estimatedMinutes || 0) / 60)}h{' '}
                            {(stop.estimatedMinutes || 0) % 60}m
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="flex-1 bg-red-50 border-2 border-red-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="px-3 py-1 bg-red-600 text-white rounded-full text-sm">
                        {route.distanceKm} km • {Math.floor(route.estimatedMinutes / 60)}h{' '}
          ...
          {activeTab === 'trips' && (
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-gray-900">Scheduled Trips</h2>
                <button
                  onClick={() => navigate('/admin/trips')}
                  className="flex items-center gap-2 text-[#2563EB] hover:bg-blue-50 px-4 py-2 rounded-lg transition-colors"
                >
                  View All Trips
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl">
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  >
                    ...
                    {availableStops
                      .filter(
                        (s) =>
                          s.id !== route.originStopId && s.id !== route.destinationStopId
                      )
                      .map((stop) => (
                        <option key={stop.id} value={stop.id}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-700 mb-2">Distance from Origin (km)</label>
                    <input
                      type="number"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <label className="flex items-center gap-3 p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-[#2563EB] transition-colors">
                    <input
                      type="checkbox"
                      checked={stopFormData.isPickup}
                      onChange={(e) =>
                        setStopFormData({ ...stopFormData, isPickup: e.target.checked })
                      }
                      className="w-5 h-5 text-[#2563EB] rounded focus:ring-[#2563EB]"
                    />
                    <div>
                      <p className="text-gray-900">Allow Pickup</p>
                      <p className="text-sm text-gray-500">Passengers can board here</p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center gap-3 p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-[#2563EB] transition-colors">
                    <input
                      ...
                      onChange={(e) =>
                        setStopFormData({ ...stopFormData, isDropoff: e.target.checked })
                      }
                      className="w-5 h-5 text-[#2563EB] rounded focus:ring-[#2563EB]"
                    />
                    <div>
                      <p className="text-gray-900">Allow Drop-off</p>
                      <p className="text-sm text-gray-500">Passengers can alight here</p>
                    </div>
                  </label>
                </div>
