    ...
    if (bus) {
      setBus({
        ...
        seats: bus.seats.map((s) =>
          s.id === seatId ? { ...s, isActive: !s.isActive } : s
        ),
      });
      ...
      <div className="p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-gray-900 mb-1">Bus Details - {bus.plateNumber}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-gray-900">Bus Information</h2>
                {!isEditingBus ? (
                  <button
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-600 text-sm mb-2">Plate Number</label>
                  {isEditingBus ? (
                    <input
                      type="text"
                      value={busFormData.plateNumber}
                      onChange={(e) =>
                        setBusFormData({ ...busFormData, plateNumber: e.target.value })
                      }
                ...
                <div>
                  <label className="block text-gray-600 text-sm mb-2">Seat Capacity</label>
                  {isEditingBus ? (
                    <input
                      type="number"
                      value={busFormData.seatCapacity}
                      onChange={(e) =>
                        setBusFormData({ ...busFormData, seatCapacity: parseInt(e.target.value) || 0 })
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2563EB] text-gray-900"
                    />
                  ) : (
                ...
                <div>
                  ...
                  {isEditingBus ? (
                    ...
                    <p className="text-gray-900">{bus.status}</p>
                  )}
                </div>

                <div>
                  <label className="block text-gray-600 text-sm mb-2">Amenities</label>
                  {isEditingBus ? (
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-gray-900">{bus.seats.length}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 text-sm">Active Seats</span>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-gray-900">Seat Layout Management</h2>
                <div className="flex gap-2">
                  <button
              ...
              {bus.seats.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">No seats configured yet</p>
                  <button
                    onClick={() => setShowGenerateModal(true)}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <h2 className="text-gray-900">Auto Generate Seat Layout</h2>
                <button
              ...
              <div className="p-6 space-y-4">
                <div>
                  <label className="block text-gray-700 mb-2">Layout Pattern</label>
                  <select
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setGenerateFormData({ ...generateFormData, rows: parseInt(e.target.value) || 1 })
                    }
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2563EB] text-gray-900"
                    min="1"
                    max="20"
                ...
                <div>
                  <label className="block text-gray-700 mb-2">Start Row Number</label>
                  <input
                    type="number"
        ...
        {showAddSeatModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <h2 className="text-gray-900">Add New Seat</h2>
                <button
