...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Navigate to home (will show UserHomePage)
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 border-2 border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 transition-colors"
            >
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#10B981] to-[#059669] relative overflow-hidden">
        {/* Background Image with Overlay */}
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1740106686061-0f073f3e98da?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXMlMjBqb3VybmV5JTIwbGFuZHNjYXBlfGVufDF8fHx8MTc2Mzk2MDEwNXww&ixlib=rb-4.1.0&q=80&w=1080"
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div>
                  <h3 className="text-white mb-1">Easy Booking Process</h3>
              ...
              <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div>
                  <h3 className="text-white mb-1">Secure Payments</h3>
                  <p className="text-green-100 text-sm">
              ...
              <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div>
                  <h3 className="text-white mb-1">24/7 Customer Support</h3>
                  <p className="text-green-100 text-sm">
